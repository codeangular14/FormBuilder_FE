...
export const getMasterConfigsData = createSelector(getCommonState, fromCommon.getMasterConfigs);
export const getMenuListData = createSelector(getCommonState, fromCommon.getAllMenuList);
export const getAllSelectedUserRoleData = createSelector(getCommonState, fromCommon.getAllSelectedUserRole);
export const getSodMatrixListData = createSelector(getCommonState, fromCommon.getSodMatrixList);
